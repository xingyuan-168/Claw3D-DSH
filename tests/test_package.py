...
from ai_engineering_os import RUNTIME_VERSIONS, __version__
from ai_engineering_os.cli import app as cli_app
...
def test_package_module_entrypoint_dispatches_cli(
    ...
    runpy.run_path(str(entrypoint), run_name="ai_engineering_os.not_main")
