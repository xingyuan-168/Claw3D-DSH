...
Run these in order, then call `governance_check(stage="finish", tests_passed=true, docs_synced=true, memory_written=true)` or declare `memory_not_needed=true` (CLI: `aios finish ...`). The gate re-verifies the repository side itself.
