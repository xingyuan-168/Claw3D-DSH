"""Minimal, reviewable documents created by "aios init" (ADR-0016).
...
1. 不改变 DeepSeek Harness 原生工程方式：AIOS 只治理"能否做、何时做、做完留什么"；Agent、Subagent、Workflow、Team、Task、Session、Tool、Approval、Sandbox、Workspace、Model 都归 DSH。
...
7. 复杂并行任务使用 DSH 原生 Agent/Subagent + .worktrees/ 隔离，完成后清理。
