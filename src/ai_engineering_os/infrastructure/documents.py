...
removed with ADR-0016; affected-document syncing stays a lead-agent process
...
from ai_engineering_os.templates.project_docs import documents_for
...
class DocumentManager:
    ...
    def generate_context(self) -> Path:
        ...
        context_path = self.resolve(".aios/context/PROJECT_CONTEXT.md")
        self.write_atomic(
