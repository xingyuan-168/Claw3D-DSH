...
principal roles: the lead agent is one professional actor, and the kernel judges
operations, not job titles. Gate decisions live in ``ai_engineering_os.core.gates``
...
from ai_engineering_os.domain.governance import is_unsafe_repository_path
